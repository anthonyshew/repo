...
const audioFile = path.join(folder, "screen.mov");
...
if (!existsSync(audioFile)) {
	...
	console.error("Place your screen.mov recording in public/2-10/");
	process.exit(1);
}
...
if (existsSync(captionsPath)) {
	...
	console.log("Transcribing screen.mov...");
	await captionFile({
		file: "screen.mov",
...
const silences = await detectSilence(audioFile, {
	minDuration: 0.5,
	thresholdDb: -30,
});
