...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, prompt, date, generateSingleMeal, result;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, request.json()];
                case 1:
                    _a = _b.sent(), prompt = _a.prompt, date = _a.date;
                    generateSingleMeal = effect_1.Effect.gen(function () {
                        var mealDate, result;
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    mealDate = date || Math.floor(Date.now() / 1000);
                                ...
                                case 1:
                                    result = _a.sent();
                                    if (!result.object) return [3 /*break*/, 3];
                                            ...
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0: return [4 /*yield*/, db_1.db
                                                            .insert(db_1.meals)
                                                            .values((0, schemas_1.convertMealForInsert)(result.object, mealDate))];
                                                    case 1:
                    ...
                    return [4 /*yield*/, effect_1.Effect.runPromise(effect_1.Effect.catchAll(generateSingleMeal, function (error) {
